// this file is from gmapping, but not part of the includes in
// /opt/ros/kinectic/include/gmapping
// https://github.com/OpenSLAM-org/openslam_gmapping/blob/master/scanmatcher/gridlinetraversal.h
