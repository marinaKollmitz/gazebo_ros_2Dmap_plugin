...
#include <ros/ros.h>
#include <robotino_sim/Octomap.h>
#include <sdf/sdf.hh>
...
class OctomapFromGazeboWorld : public WorldPlugin {
 public:
  ...
  {
    std::cout << "octomap plugin started" << std::endl;
  }
  ...
  */
  void CreateOctomap(const robotino_sim::Octomap::Request& msg);
 ...
 private:
  ...
  bool ServiceCallback(robotino_sim::Octomap::Request& req,
                       robotino_sim::Octomap::Response& res);
};
